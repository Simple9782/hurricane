...
# write your update damages function here: #2
...
# write your construct hurricane by year dictionary function here: #3
def construct_hurricane_by_year(names, months, years, max_sustained_winds, areas_affected, damages, deaths):
    ...
    for i in range(len(names)):
        hurricanes[names[i]] = {'Name': names[i],
                                ...
                                'Deaths': deaths[i]}
    return hurricanes
hurricanes = construct_hurricane_by_year(names, months, years, max_sustained_winds, areas_affected, updated_damages, deaths)
#print(hurricanes)


# sort hurricanes by year # 4
years_dict= []
for n, m, y, mx, af, da, d in zip(names, months, years, max_sustained_winds, areas_affected, updated_damages, deaths):
    dict = {y: {'Name': n, 'Month': m, 'Year': y, 'Max_sustained_wind': mx, 'Area_affected': af, 'Damage': da, 'Deaths': d}}
...
# write your count affected areas function here: #5
areas_count = {}
...
# write your find most affected area function here: #6
...
max_area, max_count = most_affected_area(areas_count)
...
# write your greatest number of deaths function here:#7
...
# write your catgeorize by mortality function here: #8
...
# write your greatest damage function here: #9
...
# write your catgeorize by damage function here: #10
